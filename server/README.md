...
* Using the Remote API
	...
	1. Events
		...
		* Event ShoppingList
		* Event Polls
	1. Events associated with Users
	1. Server admin
...
The following URLs can be accessed in the browser for more detailed documentation (docstrings) as well as GUI calls to requests, courtesy of the [Django REST Framework](http://www.django-rest-framework.org/).
...
## iii. Events associated with Users
